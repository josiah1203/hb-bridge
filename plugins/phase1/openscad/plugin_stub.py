...
"""Phase 1 harness-only roundtrip for Openscad (mechanical domain)."""

from __future__ import annotations

from typing import Any

PLUGIN_ID = "hb_bridge_openscad"
PLUGIN_VERSION = "0.1.0"
DOMAIN = "mechanical"
MUTATION_KIND = "mechanical/solid/upsert"
    ...
    *,
    ...
    if mutations is None:
        mutations = [
            _mutation(
                MUTATION_KIND,
                {"commitId": "openscad-export", "id": "solid-1", "name": "Openscad sample"},
            )
        ]
    return {
        "manifest": {
            "hnf_version": "0.1",
            "doc_id": "phase1-openscad-001",
            "disciplines": [DOMAIN],
        },
        "document_uri": "hbp://docs/openscad/sample",
        "objects": [
            {
                "id": "obj-openscad",
