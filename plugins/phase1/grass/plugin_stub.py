...
"""Phase 1 harness-only roundtrip for Grass (geospatial domain)."""

from __future__ import annotations

from typing import Any

PLUGIN_ID = "hb_bridge_grass"
    ...
    *,
    ...
    if mutations is None:
        mutations = [
            _mutation(
                MUTATION_KIND,
                {"commitId": "grass-export", "id": "terrain", "name": "Grass sample"},
            )
        ]
    return {
        "manifest": {
            "hnf_version": "0.1",
            "doc_id": "phase1-grass-001",
            "disciplines": [DOMAIN],
        },
        "document_uri": "hbp://docs/grass/sample",
        "objects": [
            {
                "id": "obj-grass",
