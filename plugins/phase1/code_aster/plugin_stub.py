...
"""Phase 1 harness-only roundtrip for Code Aster (structural domain)."""

from __future__ import annotations

from typing import Any

PLUGIN_ID = "hb_bridge_code_aster"
PLUGIN_VERSION = "0.1.0"
DOMAIN = "structural"
MUTATION_KIND = "structural/member/upsert"
    ...
    *,
    ...
    if mutations is None:
        mutations = [
            _mutation(
                MUTATION_KIND,
                {"commitId": "code_aster-export", "id": "beam-2", "name": "Code Aster sample"},
            )
        ]
    return {
        "manifest": {
            "hnf_version": "0.1",
            "doc_id": "phase1-code_aster-001",
            "disciplines": [DOMAIN],
        },
        "document_uri": "hbp://docs/code_aster/sample",
        "objects": [
            {
                "id": "obj-code_aster",
