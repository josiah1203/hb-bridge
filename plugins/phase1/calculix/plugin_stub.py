...
"""Phase 1 harness-only roundtrip for Calculix (structural domain)."""

from __future__ import annotations

from typing import Any

PLUGIN_ID = "hb_bridge_calculix"
    ...
    *,
    ...
    if mutations is None:
        mutations = [
            _mutation(
                MUTATION_KIND,
                {"commitId": "calculix-export", "id": "beam-3", "name": "Calculix sample"},
            )
        ]
    return {
        "manifest": {
            "hnf_version": "0.1",
            "doc_id": "phase1-calculix-001",
            "disciplines": [DOMAIN],
        },
        "document_uri": "hbp://docs/calculix/sample",
        "objects": [
            {
                "id": "obj-calculix",
