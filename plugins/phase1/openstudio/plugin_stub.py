...
"""Phase 1 harness-only roundtrip for Openstudio (energy_building domain)."""

from __future__ import annotations

from typing import Any

PLUGIN_ID = "hb_bridge_openstudio"
PLUGIN_VERSION = "0.1.0"
DOMAIN = "energy_building"
MUTATION_KIND = "energy/zone/upsert"
    ...
    *,
    ...
    if mutations is None:
        mutations = [
            _mutation(
                MUTATION_KIND,
                {"commitId": "openstudio-export", "id": "zone-1", "name": "Openstudio sample"},
            )
        ]
    return {
        "manifest": {
            "hnf_version": "0.1",
            "doc_id": "phase1-openstudio-001",
            "disciplines": [DOMAIN],
        },
        "document_uri": "hbp://docs/openstudio/sample",
        "objects": [
            {
                "id": "obj-openstudio",
