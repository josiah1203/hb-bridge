...
"""Phase 1 harness-only roundtrip for Opensees (structural domain)."""

from __future__ import annotations

from typing import Any

PLUGIN_ID = "hb_bridge_opensees"
    ...
    *,
    ...
    if mutations is None:
        mutations = [
            _mutation(
                MUTATION_KIND,
                {"commitId": "opensees-export", "id": "beam-1", "name": "Opensees sample"},
            )
        ]
    return {
        "manifest": {
            "hnf_version": "0.1",
            "doc_id": "phase1-opensees-001",
            "disciplines": [DOMAIN],
        },
        "document_uri": "hbp://docs/opensees/sample",
        "objects": [
            {
                "id": "obj-opensees",
