...
"""
KiCad HB Bridge status panel (M2 stub).

Shows connection state, last HNF export path, and link to HBW. Full wx/Pcbnew
dock integration ships with upstream PR 3 (see docs/upstream/kicad.md).
"""
...
def panel_status() -> dict[str, Any]:
    """Return serializable panel state for in-tool UI or CLI probes."""
