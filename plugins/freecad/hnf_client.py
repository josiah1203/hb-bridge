...
"""Invoke `hb-bridge-hnf` CLI for HNF v0.1 save/load (hnf-freecad crate)."""
...
def freecad_export_mechanical(
    project_path: str, mutations: list[dict[str, Any]]
) -> dict[str, Any]:
    return _run(
        "freecad",
        "export-mechanical",
...
def freecad_import_mechanical(hnf_document: dict[str, Any]) -> list[dict[str, Any]]:
    out = _run("freecad", "import-mechanical", {"hnf_document": hnf_document})
